...
@implementation UIApplicationDelegate {
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x15104);
		if (call_super && rv) {
...
@implementation Foundation_NSDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x19B04);
	}

	-(BOOL) conformsToProtocol:(void *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, 0x1B804);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x19A04);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation __MonoMac_NSSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x19E04);
	}
@end
...
@implementation Foundation_NSAsyncDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x1A004);
	}
...
@implementation __MonoMac_NSAsyncSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x1A204);
	}
@end
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, 0x1DF04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x1DD04);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		{ NULL, 0x5804 /* #0 'NSObject' => 'Foundation.NSObject, Xamarin.iOS' */ },
		{ NULL, 0x4504 /* #1 'UIApplicationDelegate' => 'UIKit.UIApplicationDelegate, Xamarin.iOS' */ },
		{ NULL, 0x4604 /* #2 'UIResponder' => 'UIKit.UIResponder, Xamarin.iOS' */ },
		{ NULL, 0x4304 /* #3 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */ },
		{ NULL, 0x4004 /* #4 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */ },
		{ NULL, 0x4204 /* #5 'UIView' => 'UIKit.UIView, Xamarin.iOS' */ },
		{ NULL, 0x4404 /* #6 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */ },
		{ NULL, 0x4804 /* #7 'NSArray' => 'Foundation.NSArray, Xamarin.iOS' */ },
		{ NULL, 0x4B04 /* #8 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */ },
		{ NULL, 0x4C04 /* #9 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */ },
		{ NULL, 0x4D04 /* #10 'NSString' => 'Foundation.NSString, Xamarin.iOS' */ },
		{ NULL, 0x5204 /* #11 'Foundation_NSDispatcher' => 'Foundation.NSDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5304 /* #12 '__MonoMac_NSSynchronizationContextDispatcher' => 'Foundation.NSSynchronizationContextDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5404 /* #13 'Foundation_NSAsyncDispatcher' => 'Foundation.NSAsyncDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5504 /* #14 '__MonoMac_NSAsyncSynchronizationContextDispatcher' => 'Foundation.NSAsyncSynchronizationContextDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5604 /* #15 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */ },
		{ NULL, 0x5E04 /* #16 'NSException' => 'Foundation.NSException, Xamarin.iOS' */ },
		{ NULL, 0x4904 /* #17 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */ },
		{ NULL, 0x300 /* #18 'AppDelegate' => 'ETraffic.AppDelegate, ETraffic' */ },
		{ NULL, 0x400 /* #19 'ViewController' => 'ETraffic.ViewController, ETraffic' */ },
		{ NULL, 0x5A04 /* #20 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */ },
		{ NULL, 0 },
	};
	...
	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		{ 0x5F04 /* Foundation.INSObjectProtocol */, 0x6004 /* NSObjectProtocolWrapper */ },
	};
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [6].handle = objc_getClass ("UIWindow");
	__xamarin_class_map [7].handle = objc_getClass ("NSArray");
	__xamarin_class_map [8].handle = objc_getClass ("NSNull");
	...
	__xamarin_class_map [17].handle = objc_getClass ("NSDictionary");
	__xamarin_class_map [18].handle = [AppDelegate class];
	__xamarin_class_map [19].handle = [ViewController class];
	__xamarin_class_map [20].handle = objc_getClass ("__NSObject_Disposer");
